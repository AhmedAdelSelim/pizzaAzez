...
export const STORIES = [
    {
        id: 's1',
        title: 'عرض خاص',
        image: require('../../assets/images/story_offer.png'),
        owner: 'عزيز',
        ownerImage: require('../../assets/images/azez.jpg'),
        isSeen: false,
    },
    {
        id: 's2',
        title: 'خلف الكواليس',
        image: require('../../assets/images/story_chef.png'),
        owner: 'عزيز',
        ownerImage: require('../../assets/images/azez.jpg'),
        isSeen: false,
    },
    {
        ...
        owner: 'بيتزا عزيز',
        ownerImage: require('../../assets/images/logo.png'),
        isSeen: false,
    },
];
